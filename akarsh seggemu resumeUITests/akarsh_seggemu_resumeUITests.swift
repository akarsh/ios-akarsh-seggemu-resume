...
class akarsh_seggemu_resumeUITests: XCTestCase {
    ...
    func testNavigationintoIntoEnglishResume() {
        ...
        app.navigationBars["akarsh_seggemu_resume.ProfilesLayoutTaableView"].buttons["Back"].tap()
